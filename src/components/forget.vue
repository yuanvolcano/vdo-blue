<template>
  <div class="wrapper">
    ...
    <div class="forget-body">
      <group class="group">
        <x-input class="ipt" @on-focus="focus" title="title" v-model="username" type="email" placeholder="请输入邮箱" is-type="email" required>
        ...
        <div class="login-width verify-width">
          <div class="user-email">
            ...
            <div class="user-email-input">
                <input v-model='code' @focus="focus" class="email-ipt verify-ipt" type="text" placeholder="请输入验证码">
            </div>
          </div>
        </div>
        <div @click="_getCode" :class="{'disable': countDown || loading}" class="login-width verify-code">
          <span ref="txt">{{txt}}</span>
        </div>
      </div>
      <group class="group">
        <x-input class="ipt" @on-focus="focus" title="title" v-model="userpwd" type="password" placeholder="请输入密码" required>
           <div class="clearfix" slot="label">
      ...
      <group class="group">
        <x-input class="ipt" @on-focus="focus" title="title" @on-blur="blurHanle" v-model="repeatpwd" type="password" placeholder="请确认密码" required>
           <div class="clearfix" slot="label">
             <div class="user-email-img pwd-img"></div>
           </div>
        </x-input>
